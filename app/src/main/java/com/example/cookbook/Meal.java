...
public class Meal {
    ...
    public ArrayList<String> getMeasurmentsList(){
        ArrayList<String> measurements= new ArrayList<String>();
        measurements.add(getStrMeasure1());
        measurements.add(getStrMeasure2());
        measurements.add(getStrMeasure3());
        measurements.add(getStrMeasure4());
        measurements.add(getStrMeasure5());
        measurements.add(getStrMeasure6());
        measurements.add(getStrMeasure7());
        measurements.add(getStrMeasure8());
        measurements.add(getStrMeasure9());
        measurements.add(getStrMeasure10());
        measurements.add(getStrMeasure11());
        measurements.add(getStrMeasure12());
        measurements.add(getStrMeasure13());
        measurements.add(getStrMeasure14());
        measurements.add(getStrMeasure15());
        measurements.add(getStrMeasure16());
        measurements.add(getStrMeasure17());
        measurements.add(getStrMeasure18());
        measurements.add(getStrMeasure19());
        measurements.add(getStrMeasure20());
        return measurements;
    }
